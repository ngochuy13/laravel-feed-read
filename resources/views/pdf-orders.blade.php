        ...
        <td class="container" width="600">
            <div class="content">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <img class="aligncenter" src="{{asset('images/logo.jpg')}}" alt="" width="200" style="width: 200px;" ></img>
                                        <!-- <div class="logo" style="background-image: \"{{asset('images/logo.jpg')}}\""></div> -->
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                ...
                <div class="footer">
                    <table width="100%">
                        <tr>
                            <td class="aligncenter content-block">Questions? Email <a href="mailto:">support@xhit
                                    .io</a></td>
                        </tr>
                    </table>
                </div>
